        ...
        <section className="articles-examples" ref={quick}>
          ...
          <article className="right-article">
            ...
            <Highlight language="javascript">
              {
                'https://sauti-africa-market-staging-3.herokuapp.com/sauti/developer'
              }
            </Highlight>
            ...
            <Highlight language="javascript">
              {
                'https://sauti-africa-market-staging-3.herokuapp.com/sauti/developer/lists/'
              }
            </Highlight>
            ...
            <Highlight language="javascript">
              {
                'https://sauti-africa-market-staging-3.herokuapp.com/sauti/developer/filter/'
              }
            </Highlight>
            ...
            <Highlight language="javascript">
              {
                'https://sauti-africa-market-staging-3.herokuapp.com/sauti/developer/product/latestprice/'
              }
            </Highlight>
            ...
            <Highlight language="javascript">
              {
                'https://sauti-africa-market-staging-3.herokuapp.com/sauti/developer/product/pricebymarket/'
              }
            </Highlight>
            ...
            <Highlight language="javascript">
              {
                'https://sauti-africa-market-staging-3.herokuapp.com/sauti/developer/product/range/'
              }
            </Highlight>
          </article>
        </section>
        <section className="articles-examples" ref={refer}>
          <article className="left-article">
            ...
            <Highlight language="javascript" className="highlight">
              {'https://sauti-africa-market-staging-3.herokuapp.com/sauti/'}
              <br />
